...
export class SubdomainsController {
    ...
    @Get('')
    async querySubdomains(@AuthSession() session: UserSession, @Param('domainId') domainId: string) {
        if (!domainId) {
    ...
    @Get(':subdomainId')
    async getSubdomain(@AuthSession() session: UserSession, @Param('subdomainId') subdomainId: string) {
    ...
    async getSubdomainOverview(
        ...
        return this.subdomainsService.getOverviewById(session, domainId, subdomainId);
    }
    ...
    async addContact(
        ...
        return this.subdomainsService.addContacts(session, domainId, subdomainId, dto);
    }
    ...
    async addResourceLink(
        ...
        return this.subdomainsService.addResourceLink(session, domainId, subdomainId, dto);
    }
}
